    ...
    <CardSpotlight className="h-96 w-96">
      ...
      <div className="text-neutral-200 mt-4 relative z-20">
        ...
        <ul className="list-none  mt-2">
            <a href="mailto:mozilla.firefox@vitbhopal.ac.in">
          <Step title="mozilla.firefox@vitbhopal.ac.in" />
          </a>
        </ul>
      </div>
      ...
      We’ve put together the answers to the most common questions.
        ...
        reach out to us at <a href="mailto:mozilla.firefox@vitbhopal.ac.in" className="text-sky-500">mozilla.firefox@vitbhopal.ac.in </a>.
      </p>
    </CardSpotlight>
  );
}
